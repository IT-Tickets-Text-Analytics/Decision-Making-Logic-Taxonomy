...
# OBJECTIVE KNOWLEDGE EXTRACTION:

# MAIN STAGES:
# STAGE 1. DML taxonomy (RTCC) (1.1.) Reading and (1.2) Stemming
# STAGE 2. Tickets Corpus Reading, Preprocessing and English language filtering
# STAGE 3. Find and Count words in the Ticket Description that match the DML Taxonomy keywords
# STAGE 4. Writing of Matched words and their Number by DML Categories in the *.csv file
...
# ________STAGE 3. Find and count words in the Ticke Description that match the DML Taxonomy keywords_________
                  try:
...
#___________________STAGE 4 Writing of Matched words and their number by DML Categories in the *csv file____________________________
